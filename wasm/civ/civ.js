...
export class WasmJpkiController {
    ...
    read_mynumber(pin) {
        ...
        const ret = wasm.wasmjpkicontroller_read_mynumber(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    read_attributes(pin) {
        const ptr0 = passStringToWasm0(pin, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmjpkicontroller_read_attributes(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_transmit_8dbb7124a9a9d94b = function() { return handleError(function (arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('civ_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
