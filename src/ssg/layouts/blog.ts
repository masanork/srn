        ...
        <article class="weba-article" style="margin-bottom: 5rem; padding-bottom: 3rem; border-bottom: 1px dashed var(--border-color);">
            <header>
                ...
                <div class="article-meta">
                    ...
                    ${d.updated ? `<span class="updated-date" title="Last modified date"><span data-i18n-ja="最終更新: " data-i18n-en="Updated: ">Updated: </span><time datetime="${d.updated}">${d.updated}</time></span>` : ''}
                    ...
                    ${d.lang ? `<span class="lang-badge" style="font-size: 0.75rem; padding: 0.1rem 0.4rem; border: 1px solid var(--border-color); border-radius: 4px; opacity: 0.8;">${d.lang.toUpperCase()}</span>` : ''}
                </div>
            </header>
    ...
    const remainingList = articles.map(item => `
        <li class="blog-list-item">
            ...
            <div class="blog-list-meta">
                ...
                ${item.updated ? `<span class="updated-date" title="Updated"><span class="sep">/</span><span data-i18n-ja="更: " data-i18n-en="U: ">U: </span>${item.updated}</span>` : ''}
                ${item.author ? `<span class="sep">/</span><span>${item.author}</span>` : ''}
                ${item.description ? `<span class="sep">/</span><span>${item.description}</span>` : ''}
                ${item.lang ? `<span class="sep">/</span><span style="opacity: 0.6; font-size: 0.8em;">${item.lang.toUpperCase()}</span>` : ''}
            </div>
        </li>
    `).join('');
