...
export const build_l2_envelope_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number, number];
export const constant_time_equal: (a: number, b: number, c: number, d: number) => number;
export const decrypt_l2_envelope_wasm: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
...
export const hkdf_sha256_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const sha256_wasm: (a: number, b: number) => [number, number];
