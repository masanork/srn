...
function aes_gcm_decrypt(key, iv, ciphertext, aad) {
  ...
  const ret = wasm.aes_gcm_decrypt(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
  if (ret[3]) {
...
function aes_gcm_encrypt(key, iv, plaintext, aad) {
  const ptr0 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  ...
  const ptr3 = passArray8ToWasm0(aad, wasm.__wbindgen_malloc);
  const len3 = WASM_VECTOR_LEN;
  const ret = wasm.aes_gcm_encrypt(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v5 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function constant_time_equal(a, b) {
  ...
  const len1 = WASM_VECTOR_LEN;
  const ret = wasm.constant_time_equal(ptr0, len0, ptr1, len1);
  return ret !== 0;
}
...
function ed25519_sign(private_key, message) {
...
function ed25519_verify(public_key, message, signature) {
...
function get_padding_target_size(current_size) {
  const ret = wasm.get_padding_target_size(current_size);
  return ret >>> 0;
}
...
function ml_dsa_44_generate_keypair() {
  const ret = wasm.ml_dsa_44_generate_keypair();
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function ml_dsa_44_sign(private_key, message) {
  const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  const ret = wasm.ml_dsa_44_sign(ptr0, len0, ptr1, len1);
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function ml_dsa_44_verify(public_key, message, signature_bytes) {
  const ptr0 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  ...
  const len2 = WASM_VECTOR_LEN;
  const ret = wasm.ml_dsa_44_verify(ptr0, len0, ptr1, len1, ptr2, len2);
  if (ret[2]) {
    throw takeFromExternrefTable0(ret[1]);
  }
  return ret[0] !== 0;
}
function ml_kem_768_decapsulate(private_key, ciphertext) {
  const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
...
function ml_kem_768_encapsulate(public_key) {
  const ptr0 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
...
function ml_kem_768_generate_keypair() {
...
function p256_generate_keypair() {
  const ret = wasm.p256_generate_keypair();
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function p256_sign(private_key, message) {
  const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  const ret = wasm.p256_sign(ptr0, len0, ptr1, len1);
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
function p256_verify(public_key, message, signature) {
  const ptr0 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  const ptr2 = passArray8ToWasm0(signature, wasm.__wbindgen_malloc);
  const len2 = WASM_VECTOR_LEN;
  const ret = wasm.p256_verify(ptr0, len0, ptr1, len1, ptr2, len2);
  if (ret[2]) {
    throw takeFromExternrefTable0(ret[1]);
  }
  return ret[0] !== 0;
}
function sha256_wasm(data) {
  const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.sha256_wasm(ptr0, len0);
  var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
  wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
  return v2;
}
...
function x25519_get_shared_secret(private_key, public_key) {
  const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ptr1 = passArray8ToWasm0(public_key, wasm.__wbindgen_malloc);
  const len1 = WASM_VECTOR_LEN;
  const ret = wasm.x25519_get_shared_secret(ptr0, len0, ptr1, len1);
  if (ret[3]) {
    throw takeFromExternrefTable0(ret[2]);
  }
  var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
var wasm, cachedUint8ArrayMemory0 = null, cachedTextDecoder, MAX_SAFARI_DECODE_BYTES = 2146435072, numBytesDecoded = 0, cachedTextEncoder, WASM_VECTOR_LEN = 0, EXPECTED_RESPONSE_TYPES, weba_crypto_wasm_default;
var init_weba_crypto_wasm = __esm(() => {
  cachedTextDecoder = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true });
  cachedTextDecoder.decode();
...
var exports_wasm_core = {};
__export(exports_wasm_core, {
  x25519GetSharedSecret: () => x25519GetSharedSecret,
  x25519GetPublicKey: () => x25519GetPublicKey,
  x25519GenerateKeyPair: () => x25519GenerateKeyPair,
  sha256Hash: () => sha256Hash,
  p256Verify: () => p256Verify,
  p256Sign: () => p256Sign,
  p256GenerateKeyPair: () => p256GenerateKeyPair,
  mlKem768GenerateKeyPair: () => mlKem768GenerateKeyPair,
  mlKem768Encapsulate: () => mlKem768Encapsulate,
  mlKem768Decapsulate: () => mlKem768Decapsulate,
  mlDsa44Verify: () => mlDsa44Verify,
  mlDsa44Sign: () => mlDsa44Sign,
  mlDsa44GenerateKeyPair: () => mlDsa44GenerateKeyPair,
  initWasmFromB64: () => initWasmFromB64,
  initWasm: () => initWasm,
  hkdfSha256: () => hkdfSha256,
  getPaddingTargetSize: () => getPaddingTargetSize,
  ed25519Verify: () => ed25519Verify,
  ed25519Sign: () => ed25519Sign,
  ed25519PublicKeyToX25519PublicKey: () => ed25519PublicKeyToX25519PublicKey,
  ed25519GenerateKeyPair: () => ed25519GenerateKeyPair,
  decryptL2Envelope: () => decryptL2Envelope,
  constantTimeEqual: () => constantTimeEqual,
  buildL2Envelope: () => buildL2Envelope,
...
function aesGcmEncrypt(key, iv, plaintext, aad) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return aes_gcm_encrypt(key, iv, plaintext, aad);
}
...
function x25519GetSharedSecret(privateKey, publicKey) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return x25519_get_shared_secret(privateKey, publicKey);
}
...
function p256GenerateKeyPair() {
  if (!initialized)
    throw new Error("WASM not initialized");
  const bytes = p256_generate_keypair();
  return {
    privateKey: bytes.slice(0, 32),
    publicKey: bytes.slice(32, 97)
  };
}
function p256Sign(privateKey, message) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return p256_sign(privateKey, message);
}
function p256Verify(publicKey, message, signature) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return p256_verify(publicKey, message, signature);
}
function mlKem768GenerateKeyPair() {
  if (!initialized)
    throw new Error("WASM not initialized");
  const bytes = ml_kem_768_generate_keypair();
  return {
    privateKey: bytes.slice(0, 2400),
    publicKey: bytes.slice(2400, 3584)
  };
}
function mlKem768Encapsulate(publicKey) {
  if (!initialized)
    throw new Error("WASM not initialized");
  const bytes = ml_kem_768_encapsulate(publicKey);
  return {
    sharedSecret: bytes.slice(0, 32),
    ciphertext: bytes.slice(32, 1120)
  };
}
function mlKem768Decapsulate(privateKey, ciphertext) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return ml_kem_768_decapsulate(privateKey, ciphertext);
}
function mlDsa44GenerateKeyPair() {
  if (!initialized)
    throw new Error("WASM not initialized");
  const bytes = ml_dsa_44_generate_keypair();
  return {
    privateKey: bytes.slice(0, 2560),
    publicKey: bytes.slice(2560, 3872)
  };
}
function mlDsa44Sign(privateKey, message) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return ml_dsa_44_sign(privateKey, message);
}
function mlDsa44Verify(publicKey, message, signature) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return ml_dsa_44_verify(publicKey, message, signature);
}
function sha256Hash(data) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return sha256_wasm(data);
}
...
function getPaddingTargetSize(currentSize) {
  if (!initialized)
    throw new Error("WASM not initialized");
  return get_padding_target_size(currentSize);
}
...
function base58ToBytes(input) {
  ...
  for (const char of input) {
    const value = BASE58_ALPHABET2.indexOf(char);
    if (value < 0) {
...
var BASE58_ALPHABET2 = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz", MULTIBASE_BASE58BTC_PREFIX = "z", hasBuffer;
...
var import_canonicalize2, WEBA_VERSION = "0.1";
var init_l2crypto = __esm(() => {
...
var exports_guest_did = {};
__export(exports_guest_did, {
  sendGuestMessage: () => sendGuestMessage,
  getOrCreateGuestDid: () => getOrCreateGuestDid,
  fetchGuestInbox: () => fetchGuestInbox
});
...
var isLocal, REMOTE_URL, RP_NAME = "SRN Guest Service";
var init_guest_did = __esm(() => {
  init_l2crypto();
  init_wasm_core();
  init_did();
  isLocal = typeof window !== "undefined" && (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1");
  REMOTE_URL = isLocal ? "http://127.0.0.1:5002/api" : "/api";
...
var init_keywrap_tool = __esm(() => {
  init_l2crypto2();
});

// src/form/client/l2crypto.ts
var exports_l2crypto = {};
__export(exports_l2crypto, {
  wrapRecipientPrivateKey: () => wrapRecipientPrivateKey,
  unwrapRecipientPrivateKey: () => unwrapRecipientPrivateKey,
  selectEpochKey: () => selectEpochKey,
  loadL2Config: () => loadL2Config,
  getPaddingTargetSize: () => getPaddingTargetSize2,
  fetchPreKey: () => fetchPreKey,
  fetchEpochRegistry: () => fetchEpochRegistry,
  deriveOrgX25519KeyPair: () => deriveOrgX25519KeyPair,
  deriveKeyPairFromPrf: () => deriveKeyPairFromPrf,
  decryptLayer2Envelope: () => decryptLayer2Envelope,
  buildLayer2Envelope: () => buildLayer2Envelope,
  b64urlEncode: () => b64urlEncode,
  b64urlDecode: () => b64urlDecode,
  ReplayGuard: () => ReplayGuard2,
  LocalStorageReplayStore: () => LocalStorageReplayStore
});

class LocalStorageReplayStore {
  key;
  nonces;
  constructor(storageKey = "weba_l2_nonces") {
    this.key = storageKey;
    this.nonces = new Set;
    this.load();
  }
...
async function getPaddingTargetSize2(currentSize) {
  await ensureWasm();
  return getPaddingTargetSize(currentSize);
}
...
function canonicalJson2(obj) {
  const result = import_canonicalize3.default(obj);
  if (result === undefined) {
    throw new Error("Failed to canonicalize JSON");
  }
  return result;
...
async function deriveOrgX25519KeyPair(params) {
  await ensureWasm();
...
async function aesGcmEncrypt3(plaintext, keyBytes, iv, aad) {
...
async function wrapRecipientPrivateKey(params) {
  ...
  return aesGcmEncrypt3(params.recipientSk, key, iv, aad);
}
async function aesGcmDecrypt3(ciphertext, keyBytes, iv, aad) {
...
async function buildLayer2Envelope(params) {
  ...
  const config = {
    ...params.config,
    recipient_pqc: params.config.recipient_pqc || undefined
  };
  const envelopeJson = buildL2Envelope(canonicalJson2(params.layer2_plain), userSk, userKid, JSON.stringify(config), createdAt);
  return JSON.parse(envelopeJson);
}
...
async function decryptLayer2Envelope(envelope, recipientSk, options) {
  ...
  if (!options?.skipReplayCheck) {
    let guard = options?.replayGuard;
    if (!guard) {
      console.warn("SECURITY WARNING: No ReplayGuard provided to decryptLayer2Envelope. Using in-memory ephemeral store. Replays will only be detected within this page session.");
      guard = new ReplayGuard2;
    }
    const isFresh = await guard.checkAndMark(envelope.meta.nonce);
    if (!isFresh) {
      throw new Error("Security Error: Replay detected (nonce used).");
  ...
  try {
    const plainJson = decryptL2Envelope(envelopeJson, recipientSk, pqcSk);
    return JSON.parse(plainJson);
  } catch (e) {
    const msg = e instanceof Error ? e.message : String(e);
    if (msg.includes("Missing PQC KEM") || msg.includes("AAD mismatch")) {
...
async function fetchPreKey(url) {
  try {
    const resp = await fetch(url);
    if (!resp.ok)
      throw new Error(`Pre-key fetch failed: ${resp.status}`);
    return await resp.json();
  } catch (e) {
...
async function fetchEpochRegistry(url) {
  try {
...
function selectEpochKey(registry) {
  const now = new Date;
  const candidate = registry.keys.find((k2) => {
    const start = new Date(k2.validFrom);
    const end = new Date(k2.validUntil);
...
async function unwrapRecipientPrivateKey(params) {
  ...
  return aesGcmDecrypt3(wrapped, key, iv, aad);
}
var import_canonicalize3;
var init_l2crypto2 = __esm(() => {
  import_canonicalize3 = __toESM(require_canonicalize(), 1);
  init_wasm_core();
  init_guest_did();
  init_l2viewer();
  init_keywrap_tool();
  if (typeof window !== "undefined") {
    window.initL2Viewer = initL2Viewer;
    window.initKeywrapTool = initKeywrapTool;
  }
});
...
var EDDSA_JCS_2022 = "eddsa-jcs-2022";
...
function bytesToMultibaseBase58btc(bytes) {
...
function encodeDidKey(publicKey, keyType) {
...
class Signer {
  ...
  async register() {
    try {
      ...
      const x2 = coseKey.get(-2);
      const y2 = coseKey.get(-3);
      if (!x2 || !y2)
...
function embedDraftState(doc, draftState) {
  ...
  async signAndDownload() {
    ...
    if (l2Enabled) {
      ...
      if (l2Config.prekey_url) {
        try {
          const { fetchPreKey: fetchPreKey2 } = await Promise.resolve().then(() => (init_l2crypto2(), exports_l2crypto));
          const preKey = await fetchPreKey2(l2Config.prekey_url);
          if (preKey) {
      ...
      if (tier === "offline" && l2Config.epoch_registry_url) {
        try {
          const { fetchEpochRegistry: fetchEpochRegistry2, selectEpochKey: selectEpochKey2 } = await Promise.resolve().then(() => (init_l2crypto2(), exports_l2crypto));
          const registry = await fetchEpochRegistry2(l2Config.epoch_registry_url);
          if (registry) {
            const epochKey = selectEpochKey2(registry);
            if (epochKey) {
      ...
      const guestDidCheckbox = document.getElementById("weba-guest-did-opt");
      if (guestDidCheckbox && guestDidCheckbox.checked) {
        try {
          const { getOrCreateGuestDid: getOrCreateGuestDid2 } = await Promise.resolve().then(() => (init_guest_did(), exports_guest_did));
          const { did, isReused } = await getOrCreateGuestDid2();
          senderDid = did;
      ...
      try {
        const { buildLayer2Envelope: buildLayer2Envelope2 } = await Promise.resolve().then(() => (init_l2crypto2(), exports_l2crypto));
        const envelope = await buildLayer2Envelope2({
          layer2_plain: data,
          config: encryptionConfig,
          user_kid: senderDid || "anonymous"
        });
    ...
    try {
      ...
      document.querySelectorAll("[data-json-path]").forEach((el) => uiKeys.add(el.dataset.jsonPath));
      document.querySelectorAll('[type="radio"]').forEach((el) => uiKeys.add(el.name));
      document.querySelectorAll("table.data-table.dynamic").forEach((el) => uiKeys.add(el.dataset.tableKey));
      const ghostFields = [];
          ...
          rowsData.forEach((rowData, idx) => {
            ...
            if (row) {
              row.querySelectorAll("input, select").forEach((input) => {
                const k2 = input.dataset.baseKey;
                if (k2 && rowData[k2] !== undefined) {
                  if (input.type === "checkbox")
                    input.checked = !!rowData[k2];
                  else
                    input.value = rowData[k2];
                }
              });
            }
          });
...
class UIManager {
  ...
  initSecuritySignal() {
    window.addEventListener("weba-security-tier-change", (e) => {
      this.updateSecurityBadge(e.detail.tier);
    });
  }
  updateSecurityBadge(tier) {
  ...
  updateVisibility() {
    document.querySelectorAll("[data-show-if]").forEach((el) => {
      ...
      let visible = true;
      if (match) {
        const [_2, key, op, quote, value] = match;
        let targetInput = document.querySelector(`[data-json-path="${key}"]`);
        if (!targetInput) {
          const row = el.closest("tr");
          if (row) {
            targetInput = row.querySelector(`[data-json-path="${key}"]`);
          }
        }
        if (targetInput) {
          const currentVal = (targetInput.type === "checkbox" || targetInput.type === "radio") && targetInput.checked ? "true" : (targetInput.type === "checkbox" || targetInput.type === "radio") && !targetInput.checked ? "false" : targetInput.value;
          ...
          if (targetInput.type === "checkbox") {
            val = targetInput.checked ? "true" : "false";
          }
          if (targetInput.type === "radio") {
        ...
        if (targetInput) {
          if (targetInput.type === "checkbox")
            visible = targetInput.checked;
          else
            visible = !!targetInput.value;
        } else {
          visible = false;
        }
      }
...
function initRuntime() {
  ...
  const l2ConfigEl = document.getElementById("weba-l2-config");
  if (l2ConfigEl) {
    tryLoadJson(l2ConfigEl).then((c) => {
      if (c) {
        w.webaL2Config = c;
        initSecuritySignal(c);
        initGuestDidOpt(c);
      }
    });
  }
  ...
  if (w.initL2Viewer)
    w.initL2Viewer();
  if (w.initKeywrapTool)
    w.initKeywrapTool();
  if (w.initAggregatorBrowser)
    w.initAggregatorBrowser();
  initPostal();
  let tm;
  document.addEventListener("input", (e) => {
      ...
      if (isZipField || isAddrField) {
        ...
        if (isZipField) {
          ...
          if (datalist && cleanVal.length >= 3) {
            const candidates = postal.suggest(cleanVal, 50);
          ...
          if (datalist && val.length >= 2) {
            const candidates = postal.suggestByAddress(val, 30);
          ...
          if (val.length >= 5) {
            ...
            const exactMatch = candidates.find((c) => `${c.pref}${c.city}${c.town}` === val);
            if (exactMatch)
              fillAddress(input, exactMatch, input.closest("tr") || input.closest(".dynamic-row") || input.closest(".address-group") || input.closest("table") || input.closest("form") || document.body, true);
          }
        }
      }
    }
    ...
    dm.updateJsonLd();
    clearTimeout(tm);
    tm = setTimeout(() => dm.saveToLS(), 1000);
  });
  console.log("Web/A Runtime Ready.");
}
function fillAddress(triggerInput, record, scope, includeZip = false) {
  const inputs = Array.from(scope.querySelectorAll("input[data-json-path], select[data-json-path]"));
...
function initSecuritySignal(l2Config) {
  ...
  (async () => {
    ...
    if (l2Config.prekey_url) {
      try {
        if ((await fetch(l2Config.prekey_url, { method: "HEAD" })).ok)
          tier = "high";
      } catch (e) {}
    }
...
function initGuestDidOpt(l2Config) {
  if (!l2Config?.enabled || !window.PublicKeyCredential)
    return;
...
class PostalLookup {
  ...
  suggest(partialZip, maxResults = 50) {
    if (!this.initialized)
      return [];
  ...
  suggestByAddress(query, maxResults = 30) {
    if (!this.initialized || query.length < 2)
      return [];
    const results = [];
    const normQuery = query.trim();
    for (const prefix in this.data) {
      if (!Object.prototype.hasOwnProperty.call(this.data, prefix))
        continue;
      const group = this.data[prefix];
      if (!group)
        continue;
...
var postalLookup = new PostalLookup;
if (typeof window !== "undefined") {
  window.postalLookup = postalLookup;
}
...
class SearchEngine {
  ...
  async initPostalLookup() {
    try {
      const postal = window.postalLookup;
      if (postal) {
  ...
  isPostalField(input) {
    ...
    return key.includes("zip") || key.includes("postal") || key.includes("郵便") || placeholder.includes("郵便");
  }
  handlePostalInput(input) {
    if (!this.postalReady) {
  ...
  renderPostalSuggestions(input, suggestions) {
    let html = "";
  ...
  fillPostalData(input, record, formatZip = false) {
    if (formatZip) {
  ...
  renderSuggestions(input, hits, labelIdx) {
    ...
    let html = "";
    topHits.forEach((h2) => {
      const rowJson = escapeHtml(JSON.stringify(h2.row));
      const displayLabel = labelIdx >= 0 ? h2.label || h2.row.join(" : ") : h2.row.join(" : ");
      html += `<div class="suggestion-item" data-val="${escapeHtml(h2.val)}" data-row="${rowJson}" style="padding:8px; cursor:pointer; border-bottom:1px solid #eee; font-size:14px; color:#333;">${escapeHtml(displayLabel)}</div>`;
    });
    const box = this.getGlobalBox();
    box.innerHTML = html;
    const rect = input.getBoundingClientRect();
  ...
  handleSelection(item) {
    ...
    if (item.classList.contains("postal-item")) {
      ...
      if (postalJson) {
        try {
          const record = JSON.parse(postalJson);
  ...
  fillField(inputs, header, value, sourceInput, onSelfFilled) {
    ...
    const target2 = inputs.find((inp) => {
      const k2 = inp.dataset.baseKey || inp.dataset.jsonPath;
      const ph = this.normalize(inp.getAttribute("placeholder") || "");
      return k2 && this.normalize(k2) === normHeader || ph === normHeader;
    });
    if (target2) {
      target2.value = value || "";
