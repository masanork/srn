...
**最新のステータス (2025-12-31):**
Red Team によるセキュリティ・アセスメント（v1～v7）を経て、パイロット運用に向けたガードレール（v2.4.0）の実装を完了した。詳細は [Web/A Security Audit Index](./governance/web-a-l2-security-audit-index.html) および [Red Team Evaluation v8 (PoC Approval)](./governance/web-a-l2-security-audit-v8.ja.html) を参照のこと。
