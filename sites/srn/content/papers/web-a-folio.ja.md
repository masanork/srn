...
日常的な操作は生体認証（Touch ID/Face ID）だけで完結しますが、これはWeb/A Folio自体が法的な本人確認書類（身分証）として機能するという意味ではありません。
厳格な本人確認（KYC）はあくまで法定された本人確認手段（マイナンバーカードや運転免許証、パスポート等）で行うべきものであり、Web/A Folioの役割は、**「提出されたVCや書類が、間違いなく本人の管理下にあるデバイスから、本人の意思で提出されたものであること」** を検証可能にすることにあります。
