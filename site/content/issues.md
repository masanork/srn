...
## 1. 暗号技術と標準化 (Cryptography & Standardization)
...
## 2. トラストアーキテクチャ (Trust Architecture)
...
## 7. 長期署名とSSGの特性 (Long-term Validation)
...
## 8. プライバシーとデータ配信 (Privacy & Delivery)
...
## 9. 表現力と機械可読性の両立 (Typography & Data Structure)
